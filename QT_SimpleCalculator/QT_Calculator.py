...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("calculator.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        self.lbl_answer.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter
        )
        self.lbl_answer.setObjectName("lbl_answer")

        self.btn_clr = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("clr"))
        ...
        self.lbl_operation = QtWidgets.QLabel(self.centralwidget)
        self.lbl_operation.setGeometry(QtCore.QRect(10, 105, 330, 50))
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(18)
        font.setBold(False)
        font.setWeight(50)
        self.lbl_operation.setFont(font)
        self.lbl_operation.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.lbl_operation.setAutoFillBackground(False)
        ...
        self.lbl_operation.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.lbl_operation.setFrameShadow(QtWidgets.QFrame.Raised)
        self.lbl_operation.setLineWidth(3)
        self.lbl_operation.setMidLineWidth(0)
        self.lbl_operation.setAlignment(
            QtCore.Qt.AlignRight | QtCore.Qt.AlignTrailing | QtCore.Qt.AlignVCenter
        )
        self.lbl_operation.setObjectName("lbl_operation")

        self.btn_divide = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("/"))
        ...
        self.btn_subtract = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("-"))
        ...
        self.btn_subtract.setStyleSheet(
        ...
        self.btn_num7 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("7"))
        ...
        self.btn_num7.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num7{\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num7.setObjectName("btn_num7")

        self.btn_multiply = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("x"))
        ...
        self.btn_num8 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("8"))
        ...
        self.btn_num8.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num8 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num8.setObjectName("btn_num8")

        self.btn_num9 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("9"))
        ...
        self.btn_num9.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num9 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num9.setObjectName("btn_num9")

        self.btn_add = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("+"))
        ...
        self.btn_num5 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("5"))
        ...
        self.btn_num5.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num5 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num5.setObjectName("btn_num5")

        self.btn_num6 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("6"))
        ...
        self.btn_num6.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num6 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num6.setObjectName("btn_num6")

        self.btn_num4 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("4"))
        ...
        self.btn_num4.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num4 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num4.setObjectName("btn_num4")

        self.btn_num1 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("1"))
        ...
        self.btn_num1.setStyleSheet(
            ...
            "}\n"
            "\n"
            "QPushButton:hover#btn_num1 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num1.setObjectName("btn_num1")

        self.btn_num2 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("2"))
        ...
        self.btn_num2.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num2 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num2.setObjectName("btn_num2")

        self.btn_num3 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("3"))
        ...
        self.btn_num3.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num3 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num3.setObjectName("btn_num3")

        self.btn_num0 = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("0"))
        ...
        self.btn_num0.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_num0 {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_num0.setObjectName("btn_num0")

        self.btn_dot = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("."))
        ...
        self.btn_dot.setStyleSheet(
            ...
            "    color: white;\n"
            "}\n"
            "QPushButton:hover#btn_dot {\n"
            "    background-color: #0c6478; /* Hover state color */\n"
            "}"
        )
        self.btn_dot.setObjectName("btn_dot")

        self.btn_equal = QtWidgets.QPushButton(self.centralwidget, clicked = lambda: self.clicked_button("="))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(
            _translate("MainWindow", "QT Calculator by Kenny Neutron")
        )
        self.lbl_answer.setText(_translate("MainWindow", "0"))
        self.btn_clr.setText(_translate("MainWindow", "CLR"))
        self.lbl_operation.setText(_translate("MainWindow", "0"))
    ...
    def clicked_button(self, which_button):
        ...
        if self.ThisOperation == 0:
            if not which_button == "clr" and not which_button == "=" and not which_button == "+" and not which_button == "-" and not which_button == "x" and not which_button == "/":
                if(self.FirstValue == "0"):
                    self.FirstValue = which_button
                else:
                    self.FirstValue = self.FirstValue + which_button
                self.update_lbl_operation()
            else:
                if which_button == "+":
                    self.ThisOperation = 1
                elif which_button == "-":
                    self.ThisOperation = 2
                elif which_button == "x":
                    self.ThisOperation = 3
                elif which_button == "/":
    ...
    def update_lbl_operation(self):
        ...
        if self.ThisOperation == 0:
           self.lbl_operation.setText(self.FirstValue)
            ...
            self.lbl_operation.setText(f"{self.FirstValue}+{self.SecondValue}")
        elif self.ThisOperation == 2:
            self.lbl_operation.setText(f"{self.FirstValue}-{self.SecondValue}")
        elif self.ThisOperation == 3:
            self.lbl_operation.setText(f"{self.FirstValue}x{self.SecondValue}")
        elif self.ThisOperation == 4:
            self.lbl_operation.setText(f"{self.FirstValue}/{self.SecondValue}")

    def get_answer(self):
        if self.ThisOperation == 1:
            print("flag")
            self.Answer = int(self.FirstValue) + int(self.SecondValue)
            self.lbl_answer.setText(str(self.Answer))
